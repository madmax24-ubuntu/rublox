...
export class MapGeneratorNode {
    ...
    init() {
        const baseMat = new THREE.MeshStandardMaterial({ color: 0x62584c, roughness: 0.94, metalness: 0.02, flatShading: true });
    ...
    _createStoneRings() {
        const ringMat = new THREE.MeshStandardMaterial({ color: 0xd4c7a3, roughness: 0.9, metalness: 0.01 });
        const seamMat = new THREE.MeshStandardMaterial({ color: 0x756956, roughness: 0.95 });
    ...
    _createCenterProps() {
        ...
        const crateMat = new THREE.MeshStandardMaterial({ color: 0x704421, roughness: 0.88, flatShading: true });
        const bandMat = new THREE.MeshStandardMaterial({ color: 0x2e2925, roughness: 0.65, metalness: 0.45 });
        ...
        for (let i = 0; i < 10; i++) {
            ...
            const body = new THREE.Mesh(crateGeo, i < 5 ? new THREE.MeshStandardMaterial({ color: lootColors[i], roughness: 0.82, flatShading: true }) : crateMat);
            body.position.y = 0.6;
            crate.add(body);
        ...
        const poleMat = new THREE.MeshStandardMaterial({ color: 0x35251d, roughness: 0.9 });
    ...
    _createSpawnPads() {
        ...
        const padMat = new THREE.MeshStandardMaterial({ color: 0x241d1a, roughness: 0.82, metalness: 0.18, flatShading: true });
