...
export class MapGenerator {
	...
	_addBiomeResidence(x, z, biome) {
		...
		// Второй этаж — перекрытие с видимым проёмом над левой лестницей
		// (L8..L11): x -8.0..-4.8, z -4.0..0.0. Проём шире, чтобы из 1 этажа
		// было хорошо видно выход наверх. Сплошной пол остаётся по бокам и за проёмом.
		addBox(w - 2 * wallT, 0.3, 2.75, 0, 4.15, -5.375, floorMat, false, true);
		addBox(w - 2 * wallT, 0.3, 6.75, 0, 4.15, 3.375, floorMat, false, true);
		addBox(0.5, 0.3, 4.0, -8.25, 4.15, -2.0, floorMat, false, true);
		addBox(13.3, 0.3, 4.0, 1.85, 4.15, -2.0, floorMat, false, true);
		...
		addBox(3, 0.3, 1.5, 6.5, 8.4, -6.25, roofMat, false, true);
