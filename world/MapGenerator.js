...
export class MapGenerator {
	...
	_addBiomeResidence(x, z, biome) {
		...
		// Второй этаж — сплошное перекрытие без дыр (x -8.5..8.5, z -6.75..6.75).
		// Проход на 2 этаж только в конце левой лестницы: верхние шаги
		// (L10/L11) выходят на уровень перекрытия, ниже — сплошной пол.
		addBox(w - 2 * wallT, 0.3, d - wallT, 0, 4.15, 0, floorMat, false, true);
