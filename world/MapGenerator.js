...
export class MapGenerator {
	...
	_addBiomeResidence(x, z, biome) {
		...
		// Второй этаж — перекрытие с широким проёмом z -6.5..0, вся ширина дома.
		// Из 1 этажа хорошо видна лестница и выход наверх. Пол — спереди и узкая полоса сзади.
		addBox(w - 2 * wallT, 0.3, 0.5, 0, 4.15, -6.75, floorMat, false, true);
