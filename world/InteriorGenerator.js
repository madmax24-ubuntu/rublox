...
export class InteriorGenerator {
    ...
    static _addTable(data, scene, addCollider, colliders, meshes, x, y, z, prop) {
        ...
        const topMat = new THREE.MeshStandardMaterial({ color: 0x8d6e63, roughness: 0.7 , side: THREE.DoubleSide, polygonOffset: true, polygonOffsetFactor: 4, polygonOffsetUnits: 2});
        ...
        const legMat = new THREE.MeshStandardMaterial({ color: 0x6d4c41, roughness: 0.8 , side: THREE.DoubleSide, polygonOffset: true, polygonOffsetFactor: 4, polygonOffsetUnits: 2});
        const legPositions = [
    ...
    static _addCrate(data, scene, addCollider, colliders, meshes, x, y, z, prop) {
        ...
        const mat = new THREE.MeshStandardMaterial({ color: 0xa1887f, roughness: 0.9, flatShading: true , side: THREE.DoubleSide, polygonOffset: true, polygonOffsetFactor: 4, polygonOffsetUnits: 2});
        const mesh = new THREE.Mesh(geo, mat);
    ...
    static _addAmmoBox(data, scene, addCollider, colliders, meshes, x, y, z, prop) {
        ...
        const mat = new THREE.MeshStandardMaterial({ color: 0x6b4226, roughness: 0.85 , side: THREE.DoubleSide, polygonOffset: true, polygonOffsetFactor: 4, polygonOffsetUnits: 2});
        const mesh = new THREE.Mesh(geo, mat);
    ...
    static _addBarrel(data, scene, addCollider, colliders, meshes, x, y, z, prop) {
        ...
        const mat = new THREE.MeshStandardMaterial({ color: 0x5d4037, roughness: 0.9 , side: THREE.DoubleSide, polygonOffset: true, polygonOffsetFactor: 4, polygonOffsetUnits: 2});
        const mesh = new THREE.Mesh(geo, mat);
    ...
    static _addConcreteBarrier(data, scene, addCollider, colliders, meshes, x, y, z, prop) {
        ...
        const h = prop.h || 0.6;
        const geo = new THREE.BoxGeometry(w, h, d);
        const mat = new THREE.MeshStandardMaterial({ color: 0x808080, roughness: 0.9 , side: THREE.DoubleSide, polygonOffset: true, polygonOffsetFactor: 4, polygonOffsetUnits: 2});
        const mesh = new THREE.Mesh(geo, mat);
        mesh.position.set(x, y + h / 2, z);
        mesh.userData.mapGenerated = true;
        scene.add(mesh);
    ...
    static generateStairs(data, scene, addCollider) {
        ...
        for (let i = 0; i < stepCount; i++) {
            ...
            const stepMat = new THREE.MeshStandardMaterial({ color: 0xbcaaa4, roughness: 0.8 , side: THREE.DoubleSide, polygonOffset: true, polygonOffsetFactor: 4, polygonOffsetUnits: 2});
        ...
        // Railing
        const railMat = new THREE.MeshStandardMaterial({ color: 0x757575, metalness: 0.5, roughness: 0.6 , side: THREE.DoubleSide, polygonOffset: true, polygonOffsetFactor: 4, polygonOffsetUnits: 2});
