// Debug: check enabled flag after spawn
const { chromium } = require("@playwright/test");

(async () => {
    console.log("=== Passage Blocker Enabled Check (after spawn) ===\n");
    ...
    // Wait for spawn timer to expire (default 10s)
    ...
    console.log("Spawn complete, checking colliders...");
